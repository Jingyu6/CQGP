...
class CQGPBuffer:
    ...
    def __str__(self):
        s = 'CQGPBuffer: buffer_size={}, cur_size={}'.format(self._max_buffer_size, self._cur_size)
        if self._cur_size > 0:
...
class CQGPQFunction:
    ...
    def __init__(self,
        ...
        self._buffer = CQGPBuffer(observation_shape, action_size, max_buffer_size)
