...
class SoftCQLImpl(SACImpl):
    ...
    def _compute_conservative_loss(
        ...
        softmax_weight = torch.nn.Softmax(dim=2)(target_values)
...
class DiscreteSoftCQLImpl(DoubleDQNImpl):
    _alpha: float
    ...
    def _compute_conservative_loss(
        ...
        softmax_weight = torch.nn.Softmax(dim=1)(policy_values)
